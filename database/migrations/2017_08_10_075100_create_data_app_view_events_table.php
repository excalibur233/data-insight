...
class CreateDataAppViewEventsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        ...
        Schema::table('data_app_view_event_meta_attributes', function (Blueprint $table) {
            ...
            $table->dropForeign('data_app_view_event_meta_attributes_data_meta_attribute_type_id_foreign');
        });
        Schema::dropIfExists('data_app_view_event_meta_attributes');
        Schema::dropIfExists('data_app_view_events');
    }
}
